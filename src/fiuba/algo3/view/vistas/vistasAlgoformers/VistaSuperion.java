...
public class VistaSuperion extends VistaAlgoformer {
    ...
    public VistaSuperion(Canvas canvasAlgoformers, Algoformer superion) {
        ...
        this.algoformerHResource = "file:src/fiuba/algo3/view/resources/images/textures/superion.png";
        this.algoformerAResource = "file:src/fiuba/algo3/view/resources/images/textures/superion.png";
